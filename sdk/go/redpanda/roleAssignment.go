...
func NewRoleAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("redpanda:index/roleAssignment:RoleAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRoleAssignment(ctx *pulumi.Context,
	...
	var resource RoleAssignment
	err := ctx.ReadResource("redpanda:index/roleAssignment:RoleAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The cluster API URL. Changing this will prevent deletion of the resource on the existing cluster
func (o RoleAssignmentOutput) ClusterApiUrl() pulumi.StringOutput {
	return o.ApplyT(func(v *RoleAssignment) pulumi.StringOutput { return v.ClusterApiUrl }).(pulumi.StringOutput)
}

// The principal to assign the role to. Specify just the username (e.g., `"john.doe"`)
func (o RoleAssignmentOutput) Principal() pulumi.StringOutput {
	return o.ApplyT(func(v *RoleAssignment) pulumi.StringOutput { return v.Principal }).(pulumi.StringOutput)
}
