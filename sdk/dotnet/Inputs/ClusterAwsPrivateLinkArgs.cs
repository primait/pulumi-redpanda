...
namespace Pulumi.Redpanda.Inputs
{
    ...
    public sealed class ClusterAwsPrivateLinkArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("status")]
        public Input<Inputs.ClusterAwsPrivateLinkStatusArgs>? Status { get; set; }

        public ClusterAwsPrivateLinkArgs()
        {
        }
        public static new ClusterAwsPrivateLinkArgs Empty => new ClusterAwsPrivateLinkArgs();
    }
}
