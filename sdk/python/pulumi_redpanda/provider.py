...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_token: Redpanda client token. You need either `access_token`, or both `client_id` and `client_secret` to use this provider. Can also be set with the `REDPANDA_ACCESS_TOKEN` environment variable.
        :param pulumi.Input[_builtins.str] azure_client_id: Used for creating and managing BYOC and BYOVPC clusters. Can also be specified in the environment as AZURE_CLIENT_ID or ARM_CLIENT_ID
        :param pulumi.Input[_builtins.str] azure_client_secret: Used for creating and managing BYOC and BYOVPC clusters. Can also be specified in the environment as AZURE_CLIENT_SECRET or ARM_CLIENT_SECRET
        :param pulumi.Input[_builtins.str] azure_subscription_id: The default Azure Subscription ID which should be used for Redpanda BYOC clusters. If another subscription is specified on a resource, it will take precedence. This can also be sourced from the `ARM_SUBSCRIPTION_ID` environment variable.
        :param pulumi.Input[_builtins.str] azure_tenant_id: Used for creating and managing BYOC and BYOVPC clusters. Can also be specified in the environment as AZURE_TENANT_ID or ARM_TENANT_ID
        :param pulumi.Input[_builtins.str] client_id: The ID for the client. You need either `client_id` AND `client_secret`, or `access_token`, to use this provider. Can also be set with the `REDPANDA_CLIENT_ID` environment variable.
        :param pulumi.Input[_builtins.str] client_secret: Redpanda client secret. You need either `client_id` AND `client_secret`, or `access_token`, to use this provider. Can also be set with the `REDPANDA_CLIENT_SECRET` environment variable.
        :param pulumi.Input[_builtins.str] gcp_project_id: The default Google Cloud Project ID to use for Redpanda BYOC clusters. If another project is specified on a resource, it will take precedence. This can also be sourced from the `GOOGLE_PROJECT` environment variable, or any of the following ordered by precedence: `GOOGLE_PROJECT`, `GOOGLE_CLOUD_PROJECT`, `GCLOUD_PROJECT`, or `CLOUDSDK_CORE_PROJECT`.
        ...
        :param pulumi.Input[_builtins.str] google_credentials_base64: Used for creating and managing BYOC and BYOVPC clusters. Is a convenience passthrough for base64 encoded credentials intended for use in CI/CD. Can also be specified in the environment as GOOGLE_CREDENTIALS_BASE64
        """
...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["google_credentials_base64"] = None if google_credentials_base64 is None else pulumi.Output.secret(google_credentials_base64)
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["accessToken", "azureClientSecret", "clientId", "clientSecret", "googleCredentials", "googleCredentialsBase64"])
