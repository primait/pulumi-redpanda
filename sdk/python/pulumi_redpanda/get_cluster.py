...
class GetClusterResult:
    ...
    def cluster_configuration(self) -> 'outputs.GetClusterClusterConfigurationResult':
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> Optional['outputs.GetClusterTimeoutsResult']:
...
def get_cluster(id: Optional[_builtins.str] = None,
                timeouts: Optional[Union['GetClusterTimeoutsArgs', 'GetClusterTimeoutsArgsDict']] = None,
...
def get_cluster_output(id: Optional[pulumi.Input[_builtins.str]] = None,
                       timeouts: Optional[pulumi.Input[Optional[Union['GetClusterTimeoutsArgs', 'GetClusterTimeoutsArgsDict']]]] = None,
