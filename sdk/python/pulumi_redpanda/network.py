...
class NetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster_type: The type of cluster this network is associated with, can be one of dedicated or byoc
...
class Network(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            timeouts: Optional[pulumi.Input[Union['NetworkTimeoutsArgs', 'NetworkTimeoutsArgsDict']]] = None) -> 'Network':
        """
