...
bin/$(PROVIDER)-v$(PROVIDER_VERSION)-%.tar.gz:
	@mkdir -p dist
	@# $< is the last dependency (the binary path from above) e.g. bin/linux-amd64/pulumi-resource-redpanda
	@# $@ is the current target e.g. bin/pulumi-resource-redpanda-v1.2.3-linux-amd64.tar.gz
