...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-redpanda/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-redpanda/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "redpanda", redpanda.Provider(),
		...
		// convention is to have a function at "github.com/redpanda-data/terraform-provider-redpanda/provider".New
		...
		Keywords:   []string{"redpanda", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/primait/pulumi-redpanda/sdk/",
